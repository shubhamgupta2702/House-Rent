...
export default function Example() {
  return (
    <div className="relative isolate overflow-hidden bg-gray-200 text-black py-16 sm:py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <div className="mt-6 flex max-w-md gap-x-4 text-black">
              ...
              <input
                ...
                autoComplete="email"
                className="min-w-0 flex-auto rounded-md border-red-700 px-3.5 py-2 text-black shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm/6"
              />
              <button
                type="submit"
