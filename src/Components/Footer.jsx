...
export default function Footer2() {
    return (
      <footer className="py-6 bg-green-600 w-full">
        <div className="container px-6 mx-auto space-y-6 divide-y text-black divide-gray-400 md:space-y-12 divide-opacity-50">
          <div className="grid grid-cols-12">
            <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
              <Link to="#" className="flex justify-center space-x-3 md:justify-start">
                ...
                <span className="self-center text-2xl font-semibold">Ghar Dekho</span>
              </Link>
            </div>
